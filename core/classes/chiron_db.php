...
class chiron_db {
	...
	public function load_schema(){
		...
		$this->schema['chiron_source']['description'] = t('Stores all Sources'); 
		...
		$this->schema['chiron_source']['fields']['id']['description'] = t('source id');
		...
		$this->schema['chiron_source']['fields']['id_source_type']['description'] = t('source type id');
		...
		$this->schema['chiron_source']['fields']['title']['description'] = t('source title');
		...
		$this->schema['chiron_source']['fields']['url']['description'] = t('source url');
		...
		$this->schema['chiron_source']['fields']['status']['description'] = t('sources status');
		...
		$this->schema['chiron_source']['fields']['lastchecked']['description'] = t('timestamp of last check of this source');
		...
		$this->schema['chiron_source_type']['description'] = t('Stores all Source-Tpyes');
		...
		$this->schema['chiron_source_type']['fields']['id']['description'] = t('source type id');
		...
		$this->schema['chiron_source_type']['fields']['title']['description'] = t('source type title');
		...
		$this->schema['chiron_source_meta']['description'] = t('Stores Metadata for each Source; possibly user depended');
		...
		$this->schema['chiron_source_meta']['fields']['id']['description'] = t('source meta id');
		...
		$this->schema['chiron_source_meta']['fields']['id_source']['description'] = t('source id');
		...
		$this->schema['chiron_source_meta']['fields']['id_user']['description'] = t('user id');
		...
		$this->schema['chiron_source_meta']['fields']['meta_key']['description'] = t('source meta key');
		...
		$this->schema['chiron_item']['description'] = t('Stores all Items'); 
		...
		$this->schema['chiron_item']['fields']['id']['description'] = t('item id');
		...
		$this->schema['chiron_item']['fields']['id_source']['description'] = t('source id');
		...
		$this->schema['chiron_item']['fields']['timestamp']['description'] = t('timestamp of the item');
		...
		$this->schema['chiron_item']['fields']['title']['description'] = t('item title');
		...
		$this->schema['chiron_item']['fields']['text']['description'] = t('item text');
		...
		$this->schema['chiron_item_meta']['description'] = t('Stores Metadata for each Item possibly user depended');
		...
		$this->schema['chiron_item_meta']['fields']['id']['description'] = t('item meta id');
		...
		$this->schema['chiron_item_meta']['fields']['id_item']['description'] = t('item id');
		...
		$this->schema['chiron_item_meta']['fields']['id_user']['description'] = t('user id');
		...
		$this->schema['chiron_item_meta']['fields']['meta_key']['description'] = t('item meta key');
		...
		$this->schema['chiron_item_meta']['fields']['meta_value']['description'] = t('item meta value');
