...
class chiron_db {
	...
	public function schema(){
		...
		$schema['chiron_source']['fields']['id']['type'] = 'serial';
		...
		$schema['chiron_source']['fields']['status'] = array();
		$schema['chiron_source']['fields']['status']['description'] = t('sources status');
		$schema['chiron_source']['fields']['status']['type'] = 'text';
		$schema['chiron_source']['fields']['status']['size'] = 'normal';

		$schema['chiron_source']['fields']['lastchecked'] = array();
		$schema['chiron_source']['fields']['lastchecked']['description'] = t('timestamp of last check of this source');
		$schema['chiron_source']['fields']['lastchecked']['type'] = 'int';
		$schema['chiron_source']['fields']['lastchecked']['size'] ='normal';
		$schema['chiron_source']['fields']['lastchecked']['not null'] = true;
		$schema['chiron_source']['fields']['lastchecked']['unsigned'] = false;
		...
		$schema['chiron_source_type']['fields']['id']['type'] = 'serial';
		...
		$schema['chiron_source_category']['fields']['id']['type'] = 'serial';
		...
		$schema['chiron_source2category']['fields']['id']['type'] = 'serial';
		...
		$schema['chiron_subscription']['fields']['id']['type'] = 'serial';
		...
		$schema['chiron_source_meta']['fields']['id']['type'] = 'serial';
		...
		$schema['chiron_item']['fields']['id']['type'] = 'serial';
		...
		$schema['chiron_item_meta']['fields']['id']['type'] = 'serial';
